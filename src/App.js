...
class App extends Component {
  ...
  renderBarChart() {
    ...
    svg.selectAll(".bar-label")
      ...
      .attr("y", d => y(d.value) - 5) // Adjust position above the bar
      .attr("text-anchor", "middle")
      .text(d => d.value.toFixed(2)) // Display value with two decimal places
      .attr("fill", "black");
  }
        ...
        <div>
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ flex: 1, padding: 10 }} align="center">
              <input type="radio" id="sex" name="option" value="sex" checked={this.state.selectedCategory === 'sex'} onChange={() => this.setState({ selectedCategory: 'sex' })} />
              <label htmlFor="sex">Sex</label>
              <input type="radio" id="smoker" name="option" value="smoker" checked={this.state.selectedCategory === 'smoker'} onChange={() => this.setState({ selectedCategory: 'smoker' })} />
              <label htmlFor="totalBill">Smoker</label>
              <input type="radio" id="day" name="option" value="day" checked={this.state.selectedCategory === 'day'} onChange={() => this.setState({ selectedCategory: 'day' })} />
              <label htmlFor="day">Day</label>
              <input type="radio" id="time" name="option" value="time" checked={this.state.selectedCategory === 'time'} onChange={() => this.setState({ selectedCategory: 'time' })} />
              <label htmlFor="totatimelBill">Time</label>
              <br />
